...
class AppSettings(object):
    ...
    def INVITATION_EXPIRY(self):
        ...
        return self._setting('INVITATION_EXPIRY', 7)
    ...
    def ADAPTER(self):
        ...
        return self._setting(
            'ADAPTER', 'authentication.adapters.BaseInvitationsAdapter')
    ...
    def INVITATION_MODEL(self):
        ...
        """
        return self._setting("INVITATION_MODEL", "authentication.Invitation")

    @property
    def INVITE_FORM(self):
        return self._setting("INVITE_FORM", "authentication.forms.InviteForm")

    @property
    def ADMIN_ADD_FORM(self):
        return self._setting(
            "ADMIN_ADD_FORM",
            "authentication.forms.InvitationAdminAddForm"
        )
    ...
    def ADMIN_CHANGE_FORM(self):
        return self._setting(
            "ADMIN_CHANGE_FORM",
            "authentication.forms.InvitationAdminChangeForm"
        )
